...
#
# Analysis compute runs on Burn (pure-Rust tensor substrate) — there is no
# vendored C++ runtime to download or stage. Setup installs the Rust
# toolchain, CMake (for the static HDF5 build), the platform GUI deps, and
# the Tauri CLI, then verifies the workspace builds.
