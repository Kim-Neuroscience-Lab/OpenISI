//! Monitor detection module using Win32 APIs.
//!
//! Enumerates connected monitors, retrieves resolution, position, refresh rate,
//! and physical dimensions (via EDID parsing). Also provides DXGI output lookup
//! for WaitForVBlank support.
